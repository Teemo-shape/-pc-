(function($){
    var bigAutocomplete = new function(){
        ...
        this.init = function(){
            $(".tv-cover").append("<div id='bigAutocompleteContent' class='bigautocomplete-layout'></div>");
        ...
        this.autocomplete = function(param){
            ...
            $this.keyup(function(event) {
                ...
                if(!isFunctionalKey && (!ctrl || (ctrl && k == 67) || (ctrl && k == 88)) ){
                    ...
                    if(data != null && $.isArray(data) ){
                        ...
                        $.post(url,{productVersion:keyword_},function(retData){
                            makeContAndShow(retData.retData)
                        },"json")
                    }
            ...
            function makeContAndShow(data_){
                ...
                for(var i=0;i<data_.length;i++){
                    cont += "<tr><td><a target='_blank' href=\""+data_[i].url+"\">" + data_[i].name + "</a></td></tr>"
                }
                cont += "</tbody></table>";
                $bigAutocompleteContent.html(cont);
                $bigAutocompleteContent.show();
